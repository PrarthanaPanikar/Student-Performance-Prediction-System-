...
def load_data():
    ...
    try:
        ...
        logger.error("Validated data file not found. Run ingest.py first")
        raise
...
def analyze_class_balance(df):
    ...
    axes[1].bar(grade_counts.index, grade_counts.values, colors=['#51cf66', '#8ce99a', '#ffd43b', '#ff8787', '#ff6b6b'])
